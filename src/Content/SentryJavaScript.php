...
class SentryJavaScript
{
    ...
    public function __invoke(Document $document)
    {
        ...
        if ($this->container->bound('fof.sentry.environment')) {
            $environment = $this->container->make('fof.sentry.environment');
        }
        if (empty($environment)) {
            $environment = str_replace(['https://', 'http://'], '', $this->url->to('forum')->base());
        }
